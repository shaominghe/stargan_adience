import os
import argparse
from age_slover import Solver
from data_AGFW import get_loader
...
def main(config):
    ...
    AGFW_loader = get_loader( config.image_size, config.batch_size,
    ...
    celeba_loader=None
    adience_loader=None
    solver = Solver(AGFW_loader, adience_loader,celeba_loader,rafd_loader, config)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='AGFW', choices=['CelebA', 'RaFD', 'Both','adience'])
    ...
    parser.add_argument('--selected_attrs', '--list', nargs='+', help='selected attributes for the CelebA dataset',
                        default=["age_7_14","age_15_24","age_25_34","age_35_44","age_44_54","age_55_94"])
    ...
    # Directories.
    parser.add_argument('--user_deconv', type=str2bool, default=False)
    parser.add_argument('--project_name' ,type=str, default='stargan_AGFW_upsample')
